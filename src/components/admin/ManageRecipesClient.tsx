      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <button
            ...
            className="bg-[#637402] text-white px-5 py-2 rounded-2xl hover:opacity-90 transition cursor-pointer"
          >
            + New Recipe
          </button>
        </div>
        ...
        <div className="mt-6 bg-white rounded-3xl border border-[#637402]/20 shadow-sm p-4 md:p-5">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <select
              ...
              className="w-full rounded-2xl border border-[#637402]/20 px-4 py-2 outline-none bg-white text-gray-400 cursor-pointer"
            >
            ...
            <div className="flex items-center justify-between md:justify-end gap-3">
              ...
              <button
                ...
                className="text-[#637402] hover:underline font-semibold cursor-pointer"
              >
                Reset
              </button>
            </div>
            ...
            >
              <div className="md:col-span-5">
                <div className="flex items-center gap-3">
                  <img
                    src={
                      r.coverImage ?? 'https://picsum.photos/seed/food/120/120'
                    }
                    alt=""
              ...
              <div className="md:col-span-1 flex md:justify-end">
                <div className="relative">
                  <button
                    ...
                    className="w-10 h-10 rounded-2xl border border-[#637402]/20 hover:bg-[#DFD3A4]/30 transition text-[#637402] font-bold cursor-pointer"
                  >
                    ⋯
                  </button>
                  {openMenuId === r.id && (
