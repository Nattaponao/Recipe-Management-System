    ...
    <div className="grid grid-cols-3 mt-9 pb-14">
      <div className="col-span-1">
        <form onSubmit={handleSubmit}>
          <label className="font-semibold text-xl text-black" htmlFor="name">
            Name
          </label>
          <input
          ...
          <input
            className="block p-1.5 border border-black outline-0 rounded-sm w-85 mt-4 mb-5 text-gray-400"
            type="password"
            id="password"
          ...
          <p className="font-extralight my-1.5 text-black">
            ...
            <Link className="text-[#FE9F4D] hover:underline" href="/login">
              Login
            </Link>
          </p>
        </form>
