    ...
    <div className={`${fredoka.className} bg-[#F9F7EB]`}>
      <div className='container mx-auto'>
        <div className='flex justify-between items-center py-3.5'>
          ...
          <div>
            <Link href='/register' className='bg-[#067429] text-white py-1.5 px-6.5 rounded-2xl cursor-pointer'>
              Sign up
            </Link>
          </div>
        </div>
        <h1 className='text-[#DFD3A4] text-[105px] font-semibold mt-4'>Login now</h1>
          ...
          <div className='flex justify-between items-center'>
            ...
            <div className='flex bg-[#637402] h-1/2 py-4 px-9 justify-center rounded-2xl'>
              <div className='flex flex-col justify-center items-center'>
                ...
                <Link href='/register' className='bg-black text-[#E4D7AA] font-extralight text-[16px] py-2 px-5 mt-5 mb-3 rounded-3xl'>Resgister Now!</Link>
              </div>
            </div>
          </div>
        </div>
